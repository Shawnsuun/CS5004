...
public interface ListADT<T> {
  ...
  /**
   * A general purpose filter higher order function on this list, that returns
   * a new list based on the sent predicate
   * @param Predicate for the filter
   * @return the resulting list filtered based on the sent predicate
   */
